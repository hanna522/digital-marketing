...
public class OrderItem {
    ...
    int actualPrice;
    int quantity;
    GeneralOrder selectedOrder;
    SolutionOrder selectedSolutionOrder;
    // need to add budget to calculate PricePerformance
...
//The following calculates what the price gain would have been if products were sold at target price
    ...
    public int calculatePricePerformance() { // calculate profit
    ...
    public void changeActualPrice(int p) {
        actualPrice = p;
    }
