...
public class Product {
    ...
    private String producttype; // for detailed solution offer data
    ...
    public Product(String n, int fp, int cp, int tp, String t) {
        name = n;
        floorPrice = fp;
        ceilingPrice = cp;
        targetPrice = tp;
    ...
    public int getNumberOfTotalProductSales() {
