...
public class ProductSummary {
    ...
    boolean alwaysabovetarget;
    int rank; // will be done later
    
    public ProductSummary(Product p){
        
        numberoftotalsales = p.getNumberOfTotalProductSales();
        ...
        alwaysabovetarget = p.isProductAlwaysAboveTarget();
    ...
    public boolean isProductAlwaysAboveTarget(){
        return alwaysabovetarget; // to be implemented
    }

    public void printProductSummary(){
        System.out.println(subjectproduct.toString() + " | " + acutalsalesvolume + " | " + numberofsalesabovetarget + " | " + productpriceperformance);
    }
